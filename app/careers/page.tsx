  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative isolate overflow-hidden border-b">
        ...
        {/* Fix: add horizontal padding + safer base padding */}
        <div className="relative container px-4 py-14 sm:px-6 sm:py-20 md:py-28 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-7 text-slate-200">
            We value ownership, clear communication, and shipping work that
            teams can maintain. If you are practical, curious, and delivery
            focused, we would like to hear from you.
          </p>
      ...
      <section className="bg-slate-50">
        ...
        <div className="container px-4 py-16 sm:px-6 lg:px-8">
          {/* Fix: stack header row on mobile */}
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                We post roles here first. If you do not see a match, you can
            ...
            <Link
              href="/contact"
              className="hidden rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900/40 sm:inline-flex"
            >
              Contact us
            </Link>
          </div>
          ...
          <div className="mt-10">
            {hasJobs ? (
                    ...
                    <div className="relative">
                      ...
                      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                        <Link
                          ...
                          className="inline-flex w-full items-center justify-center rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 sm:w-auto"
                        >
                        ...
                        <Link
                          href="/contact"
                          className="inline-flex w-full items-center justify-center rounded-xl border border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-900 hover:bg-slate-50 sm:w-auto"
                        >
                          Ask a question
                        </Link>
                      </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                {/* Fix: stack icon + content on tiny widths, align on sm */}
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                      If you want to be considered for future roles, send your
                      resume and a short note about what you want to work on.
                    </p>
                    ...
                    <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                      ...
                      <Link
                        ...
                        className="inline-flex w-full items-center justify-center rounded-xl border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-50 sm:w-auto"
                      >
        ...
        <div className="container px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-slate-600">
              Modern tools evolve fast. We keep strong experience across cloud,
              analytics, and automation to deliver maintainable solutions.
            </p>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-3 md:items-center">
              <div className="md:col-span-2">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Reach out anyway. We move fast and can ramp into new stacks
                  quickly if the problem is worth solving.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row md:justify-end">
                <Link
                  href="/contact"
                  className="inline-flex w-full items-center justify-center rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 sm:w-auto"
                >
                  Contact us
                </Link>
                <Link
                  href="/services"
                  className="inline-flex w-full items-center justify-center rounded-xl border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-white sm:w-auto"
                >
                  View services
                </Link>
              </div>
